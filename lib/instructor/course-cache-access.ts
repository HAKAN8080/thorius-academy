...
export function normalizeCoursesCacheRow(
  ...
  return {
    ...
    description_md_en: (row.description_md_en as string | null) ?? null,
    ...
    what_will_learn_en: (row.what_will_learn_en as string | null) ?? null,
    target_audience_en: (row.target_audience_en as string | null) ?? null,
    seo_title: (row.seo_title as string | null) ?? null,
    seo_description: (row.seo_description as string | null) ?? null,
    seo_title_en: (row.seo_title_en as string | null) ?? null,
    seo_description_en: (row.seo_description_en as string | null) ?? null,
