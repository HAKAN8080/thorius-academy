-- PROD apply: category + print_year on library_books
-- node scripts/apply-supabase-sql.mjs supabase/manual/20260719010000_library_books_category_print_year_prod_apply.sql
