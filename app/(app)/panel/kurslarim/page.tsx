...
export default async function MyCoursesPage({
  ...
  const showPendingEmpty = pendingPurchase && enrollments.length === 0;
          ...
          {showPendingEmpty ? (
            ...
            <>
              <p className="mx-auto mb-6 max-w-md text-muted-foreground">
                ...
                hemen başlayın. Daha önce satın aldığınız kurslar giriş
                yaptığınızda otomatik senkronize edilir.
              </p>
              <Button
                asChild
                size="lg"
